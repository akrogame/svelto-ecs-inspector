...
namespace AkroGame.ECS.Websocket
{
    public class InspectorService
    {
        ...
        public InspectorService(IWebSocket ws, EnginesRoot enginesRoot)
        {
            ...
            this.groupEntityComponentsDB = enginesRoot.GetGroupEntityComponentsDB();
        ...
        private void Subscribe(int id, Span<string> args)
        {
            ...
            switch (stream)
            {
                ...
                case STREAM_ENTITIES:
                    ...
                    entitySearchDataStream.Subscribe(id, new SearchContext(HttpUtility.UrlDecode(searchQuery)));
                    break;
            }
        }
